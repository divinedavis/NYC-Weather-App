...
const orgSchema = {
  ...
  name: 'City Weather',
  url: 'https://cityweather.app',
  logo: 'https://cityweather.app/favicon.ico',
...
const siteSchema = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: { '@type': 'EntryPoint', urlTemplate: 'https://cityweather.app/{city}/{district}' },
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        <header className="text-center mb-12">
          ...
          <div className="mt-4 flex justify-center gap-4 text-sm">
            <Link href="/weather-near-me" className="text-blue-300 hover:text-white transition underline">
              📍 Weather Near Me
            </Link>
            <Link href="/guides" className="text-blue-300 hover:text-white transition underline">
              City Weather Guides
            </Link>
          </div>
        </header>
        ...
        <footer className="mt-12 text-center text-blue-300 text-xs">
          ...
          <nav className="mt-4 flex flex-wrap justify-center gap-4">
            <Link href="/weather-near-me" className="hover:text-white transition">Weather Near Me</Link>
            <Link href="/guides" className="hover:text-white transition">Weather Guides</Link>
            <Link href="/embed" className="hover:text-white transition">Weather Widget</Link>
          </nav>
        </footer>
      </main>
    </>
